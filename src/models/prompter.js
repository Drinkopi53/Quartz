...
export class Prompter {
    constructor(agent, profile) {
        ...
        if (settings.disable_llm || settings.manual_only) {
            console.log('LLM is disabled. Skipping model client initialization.');
            this.chat_model = null;
            this.code_model = null;
            this.vision_model = null;
    ...
    async initExamples() {
        if (settings.disable_llm || settings.manual_only) {
            console.log('LLM is disabled. Skipping examples initialization.');
            return;
        }
        try {
